...
import { Helmet } from 'react-helmet-async'
import {
  HiArrowRight, HiCheckCircle, HiBriefcase, HiUserGroup,
  HiOfficeBuilding, HiShieldCheck, HiTrendingUp, HiClock, HiStar, HiPhone,
} from 'react-icons/hi'
import { jobAPI } from '../services/api'
...
const SERVICES = [
  {
    num: '01',
    title: 'Executive Staffing',
    description: 'Targeted leadership hiring for growing companies that need capability, speed, and cultural fit.',
...
const DIFFERENTIATORS = [
  {
    icon: HiTrendingUp,
    title: 'Business-first recruitment',
    description: 'We understand team structure and commercial context — not just job descriptions — so every shortlist is relevant.',
  },
  {
    icon: HiShieldCheck,
    title: 'Trust-led candidate filtering',
...
function SectionLabel({ children }) {
  return (
    <div className="flex items-center gap-3 mb-4">
      ...
      <span className="text-[11px] uppercase tracking-[0.35em] text-amber-500 font-bold">{children}</span>
    </div>
  )
}
...
export default function Home() {
  ...
  return (
    <>
      <Helmet>
        <title>ProLink Consultancy | Premium Staffing, Hiring & Career Solutions</title>
        <meta name="description" content="ProLink Consultancy delivers premium staffing, recruitment, campus hiring, CV writing, and workforce support for ambitious businesses and professionals." />
      </Helmet>
    ...
    <p className="text-base md:text-lg text-stone-300 leading-relaxed mb-8 max-w-xl">
      ProLink Consultancy connects ambitious companies with exceptional
      talent while helping professionals unlock better career opportunities
            ...
            {STATS.map((item, i) => {
              ...
              return (
                <Reveal key={item.label} delay={i * 0.07}>
                  <div ref={ref} className="text-center py-4 lg:py-0 lg:px-8 first:lg:pl-0 last:lg:pr-0">
                    <div className="text-4xl xl:text-5xl font-bold text-[#8B2A0F] dark:text-amber-400 mb-2"
                      style={{ fontFamily: "'Georgia', serif" }}>
                      {inView ? <CountUp end={item.value} duration={2.5} separator="," /> : '0'}{item.suffix}
                    </div>
          ...
          <div className="grid lg:grid-cols-[1fr_2fr] gap-16 items-start">
            <Reveal>
              <div className="lg:sticky lg:top-28">
                ...
                <h2 className="text-4xl font-bold text-stone-900 dark:text-white leading-tight mb-5"
                  style={{ fontFamily: "'Georgia', serif" }}>
                  A consultancy experience that feels premium from first impression to delivery.
                </h2>
                <p className="text-stone-500 dark:text-stone-400 leading-relaxed mb-8">
                  Every engagement is handled with commercial clarity, professional polish, and a focus on outcomes that matter.
                </p>
                <Link to="/services"
                  ...
                  <div className="group rounded-2xl border border-stone-200 dark:border-stone-800 bg-stone-50 dark:bg-[#1a1108] hover:border-amber-300/60 dark:hover:border-amber-800/60 hover:bg-amber-50/30 dark:hover:bg-[#1f1309] transition-all p-7">
                    <div className="flex items-start gap-6">
                      <div className="flex-shrink-0">
                        <span className="text-[11px] font-bold text-amber-500/60 uppercase tracking-[0.3em]">{s.num}</span>
    ...
    />
      ...
      <div className="text-center max-w-4xl mx-auto mb-16">
        ...
        <p className="text-stone-400 text-base md:text-lg leading-relaxed max-w-2xl mx-auto">
          When a consultancy brand feels refined, reliable, and professional,
          clients naturally trust the service behind it.
        </p>
      </div>
          </Reveal>
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-12">
            <Reveal>
              <div>
                ...
                <h2 className="text-4xl font-bold text-stone-900 dark:text-white leading-tight"
                  style={{ fontFamily: "'Georgia', serif" }}>
            ...
            <Reveal delay={0.06}>
              <div className="flex gap-3 flex-shrink-0">
                <Link to="/jobs"              className="inline-flex items-center gap-2 px-5 py-2.5 bg-[#8B2A0F] text-white font-bold rounded-xl text-sm hover:bg-[#a03212] transition-colors">Browse All Jobs</Link>
                <Link to="/employer/post-job" className="inline-flex items-center gap-2 px-5 py-2.5 border border-stone-300 dark:border-stone-700 text-stone-700 dark:text-stone-300 font-semibold rounded-xl text-sm hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors">Post a Role</Link>
              </div>
            </Reveal>
          </div>
          ...
          <div className="grid gap-4">
            {(featuredJobs.length
              ...
              : Array.from({ length: 4 }, (_, i) => ({
                  _id: i, title: 'Senior Recruitment Consultant', type: 'full_time',
                  company: { name: 'ProLink Partner' }, location: 'Chennai', slug: 'jobs'
                }))
            ).slice(0, 4).map((job, i) => (
        ...
        <div className="relative z-10 flex flex-col xl:flex-row items-center justify-between gap-12">
          ...
          <div className="max-w-2xl text-center xl:text-left">
            ...
            <p className="text-base md:text-lg text-amber-100/80 leading-relaxed max-w-xl mx-auto xl:mx-0">
              Premium hiring support, stronger business authority,
              and a consultancy experience that feels professional from the very first interaction.
            </p>
